const STEAM_GAMES_DATABASE = {
        ...
        "packages": [
            {
                ...
                "description": "",
                "subs": [
                    { "text": "Galactic Bowling - $19.99", "description": "", "price": 19.99 }
                ]
            }
        ],
    ...
    "655370": {
        ...
        "price": 0.99,
        "dlc_count": 0,
        "detailed_description": "THE LAW!! Looks to be a showdown atop a train. This will be your last fight. Good luck, Train Bandit. WHAT IS THIS GAME? Train Bandit is a simple score attack game. The Law will attack you from both sides. Your weapon is your keyboard. You'll use those keys to kick the living shit out of the law. React quickly by attacking the correct direction. React...or you're dead. THE FEATURES Unlock new bandits Earn Achievements Become Steam's Most Wanted ? Battle elite officers Kick the law's ass",
        "about_the_game": "THE LAW!! Looks to be a showdown atop a train. This will be your last fight. Good luck, Train Bandit. WHAT IS THIS GAME? Train Bandit is a simple score attack game. The Law will attack you from both sides. Your weapon is your keyboard. You'll use those keys to kick the living shit out of the law. React quickly by attacking the correct direction. React...or you're dead. THE FEATURES Unlock new bandits Earn Achievements Become Steam's Most Wanted ? Battle elite officers Kick the law's ass",
        "short_description": "THE LAW!! Looks to be a showdown atop a train. This will be your last fight. Good luck, Train Bandit.",
        "reviews": "",
        ...
        "packages": [
            {
                ...
                "description": "",
                "subs": [
                    { "text": "Train Bandit - $0.99", "description": "", "price": 0.99 }
                ]
            }
        ],
        ...
        "categories": [
            ...
            "Steam Leaderboards", "Remote Play on Phone", "Remote Play on Tablet", "Remote Play on TV"
        ],
        "genres": ["Action", "Indie"],
        "screenshots": [
        ...
        "peak_ccu": 0,
        "tags": {
            "Indie": 109, "Action": 103, "Pixel Graphics": 100, "2D": 97, "Retro": 93, "Arcade": 86,
            "Score Attack": 84, "Minimalist": 82, "Comedy": 76, "Singleplayer": 69, "Fast-Paced": 65,
            "Casual": 62, "Funny": 58, "Parody ": 55, "Difficult": 53, "Gore": 46, "Violent": 37,
            "Western": 34, "Controller": 30, "Blood": 28
        }
    }
};
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = STEAM_GAMES_DATABASE;
}